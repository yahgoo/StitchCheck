...
async function handleExtract(req, res, env, getAdapter) {
  ...
  const previousCallCount = typeof adapterMod._resetCallCount === 'function'
    ...
    : null;
  // #region agent log
  fetch('http://127.0.0.1:7403/ingest/aac4d69a-d129-4aeb-abd0-e30af84b4350',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9c1bf5'},body:JSON.stringify({sessionId:'9c1bf5',runId:'post-fix',hypothesisId:'C',location:'openrouter-extract.mjs:handleExtract',message:'reset adapter call count per HTTP request',data:{previousCallCount,resetApplied:previousCallCount !== null},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
